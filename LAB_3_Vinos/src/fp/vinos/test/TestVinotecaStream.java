...
import fp.tipos.Vino;
import fp.tipos.Vinoteca;
import fp.tipos.FactoriaVinos;
import fp.tipos.VinotecaStream;

public class TestVinotecaStream {
	...
	public static void main(String[] args) {
		...
		Vinoteca vinos1 = new VinotecaStream(lista_vinos);
	...
	public static void testConstructor(Collection<Vino> coleccion_vinos) {
		...
		try {
			Vinoteca vinos = new VinotecaStream(coleccion_vinos);
